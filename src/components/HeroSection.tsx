        ...
        {!videoError ? (
          <div className="relative w-full h-full">
            <iframe
              ...
              src="https://www.youtube-nocookie.com/embed/19oE95Rjf0k?autoplay=1&mute=1&loop=1&playlist=19oE95Rjf0k&controls=0&rel=0&modestbranding=1&playsinline=1&start=0&iv_load_policy=3&fs=0&cc_load_policy=0&disablekb=1&si=Ts-rGv1xDCn2hB4G"
