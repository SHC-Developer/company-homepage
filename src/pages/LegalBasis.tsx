      ...
      <main className="pt-20">
        ...
        <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute right-14 top-8 opacity-10">
                ...
                <div className="sticky top-28">
                  <div className="rounded-lg border border-border bg-white p-5 shadow-sm">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <p className="text-sm font-semibold tracking-wide text-foreground/80 font-korean">목차</p>
                    </div>
                    <nav aria-label="Table of contents" className="text-sm font-korean">
                      <ul className="space-y-2">
                        <li><a href="#laws-list" className="text-foreground/80 hover:text-primary">수의계약 체결 가능한 법률조항</a></li>
                        <li><a href="#qa" className="text-foreground/80 hover:text-primary">질의회신자료</a></li>
                        <li className="pt-2 text-foreground/60">관련 법령</li>
                        <li className="ml-3"><a href="#act-veterans" className="text-foreground/80 hover:text-primary">국가유공자단체법</a></li>
                        <li className="ml-3"><a href="#basiclaw-veterans" className="text-foreground/80 hover:text-primary">국가보훈 기본법</a></li>
                        <li className="ml-3"><a href="#decree-national" className="text-foreground/80 hover:text-primary">국가계약법 시행령</a></li>
                        <li className="ml-3"><a href="#decree-local" className="text-foreground/80 hover:text-primary">지방계약법 시행령</a></li>
                      </ul>
                    </nav>
                  </div>
                </div>
              ...
              <div className="lg:col-span-9">
                <div className="bg-white rounded-xl shadow-sm border border-border">
                  <div className="p-7 md:p-8 text-base leading-8 font-korean text-foreground space-y-10" style={{ wordBreak: 'keep-all', overflowWrap: 'break-word' }}>
                    ...
                    {/* Law sections */}
                    <section id="act-veterans" className="pt-2 border-t border-gray-200">
                      <div className="flex items-center justify-between">
                        <h3 className="font-bold mb-2 text-lg">● <span style={{ textDecoration: 'underline' }}>국가유공자 등 단체 설립에 관한 법률 (약칭: 국가유공자단체법)</span></h3>
                    ...
                    <section id="basiclaw-veterans" className="pt-2 border-t border-gray-200">
                      <div className="flex items-center justify-between">
                    ...
                    <section id="decree-national" className="pt-2 border-t border-gray-200">
                      <div className="flex items-center justify-between">
                        <h3 className="font-bold mb-2 text-lg">● <span style={{ textDecoration: 'underline' }}>국가를 당사자로 하는 계약에 관한 법률 시행령 (약칭: 국가계약법 시행령)</span></h3>
                    ...
                    <section id="decree-local" className="pt-2 border-t border-gray-200">
                      <div className="flex items-center justify-between">
                        <h3 className="font-bold mb-2 text-lg">● <span style={{ textDecoration: 'underline' }}>지방자치단체를 당사자로 하는 계약에 관한 법률 시행령 (약칭: 지방계약법 시행령)</span></h3>
                        <span className="inline-flex items-center gap-1 rounded bg-slate-100 px-2 py-1 text-xs text-slate-700">시행 2025.10.01<span className="text-slate-400">/</span> 대통령령 제35811호</span>
                      </div>
                      <div className="rounded-md border border-slate-200 p-5">
